...
const Footer = () => {
    return (
        <div className='bg-black text-white'>
            <div className='flex gap-10 max-w-[1200px] mx-auto row-auto py-15'>
                ...
                <div className='flex-1 '>
                    <ul className='space-y-2 text-[#A1A1AA]'>
                        ...
                        <li className='flex items-center'> <img src={twitter} className='pr-1 h-[17px] w-[20px]' alt="" />@CS—Ticket System</li>
                        <li className='flex items-center'> <img src={twitter} className='pr-1 h-[17px] w-[20px]' alt="" />@CS—Ticket System</li>
                        <li className='flex items-center'> <img src={twitter} className='pr-1 h-[17px] w-[20px]' alt="" />support@cst.com</li>
                    </ul>
                </div>
            </div>
            <div>
